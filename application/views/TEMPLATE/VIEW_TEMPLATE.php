  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="<?= base_url(); ?>" class="brand-link">
        <span style="margin-left: 10px;" class="brand-text font-weight-light">SELAMAT DATANG
          <?php
          if ($this->session->userdata('level') == '1') {
          ?>
            ADMIN
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="<?= base_url('vendor/img/logo.jpg'); ?>" class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
        ...
        <?php } else if ($this->session->userdata('level') == '2') { ?>
          ...
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item has-treeview">
              <li class="nav-item">
                <a href="<?= base_url('index.php/user/beranda') ?>" class="nav-link">
              ...
              <li class="nav-item has-treeview">
              <li class="nav-item">
                <a href="<?= base_url('index.php/user/profil') ?>" class="nav-link">
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2020 <a href="<?= base_url(); ?>">Islamic Study Club</a>.</strong> All rights
      reserved.
    </footer>
